...
contract RaffleTest is CodeConstants, Test {
    ...
    function testCheckUpKeepReturnFalseIfRaffleNoOpen() public {
        // Arrange
        vm.prank(PLAYER);
        raffle.enterRaffle{value: entranceFee}();
        vm.warp(block.timestamp + interval + 1); // Update the time
    ...
    /*//////////////////////////////////////////////////////////////
                                BIG TEST
    //////////////////////////////////////////////////////////////*/  
    function testFulfillrandomWordsPicksAWinnerResetsAndSendingsMoney() public raffleEntered skipFork {
        // Arrange
